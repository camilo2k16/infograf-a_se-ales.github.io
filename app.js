          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                  ...
                  <XAxis dataKey="index" label={{ value: 'Muestra', position: 'insideBottom', offset: -5 }} />
                  <YAxis label={{ value: 'Velocidad (V)', angle: -90, position: 'insideLeft' }} />
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="V" stroke="#8b5cf6" strokeWidth={2} dot={{ r: 3 }} name="Velocidad" />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="index" label={{ value: 'Muestra', position: 'insideBottom', offset: -5 }} />
                  <YAxis label={{ value: 'Velocidad Angular (W)', angle: -90, position: 'insideLeft' }} />
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="W" stroke="#10b981" strokeWidth={2} dot={{ r: 3 }} name="Velocidad Angular" />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="index" label={{ value: 'Muestra', position: 'insideBottom', offset: -5 }} />
                  <YAxis label={{ value: 'PWM', angle: -90, position: 'insideLeft' }} />
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="PWM" stroke="#f59e0b" strokeWidth={2} dot={{ r: 3 }} name="PWM" />
                </LineChart>
              </ResponsiveContainer>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="t" label={{ value: 'Tiempo (t)', position: 'insideBottom', offset: -5 }} />
                  <YAxis label={{ value: 'PWM', angle: -90, position: 'insideLeft' }} />
                  <Tooltip />
                  <Legend />
                  <Line type="monotone" dataKey="PWM" stroke="#ef4444" strokeWidth={2} dot={{ r: 3 }} name="PWM" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
...
ReactDOM.render(<MotorDataVisualizer />, document.getElementById('root'));
